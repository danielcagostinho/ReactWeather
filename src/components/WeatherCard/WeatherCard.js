...
import { WiDaySunny, WiDayCloudy, WiDayRain, WiDaySunnyOvercast } from 'weather-icons-react';
...
const weatherCard = ({ date, tempMax, weather, celsius}) => {
  ...
  let tempMaxString = celsius ? Math.round(tempMax - 273.15) : Math.round(tempMax * 9/5 - 459.67);
